...
- [🛠️ API Эндпоинты](#️-api-эндпоинты)
...
| ⏱️ **Study Timer** | Отслеживание времени учёбы | Трекинг сессий, статистика по предметам, история сессий, графики распределения времени, календарь активности |
...
- 🗑️ **Удаление аккаунта** с каскадным удалением всех данных
